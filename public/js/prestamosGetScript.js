///// GET/////
fetch("/prestamos/get") //hace una llamada a la url del app.get. //cuando reciba la respuesta del app.get del index.js, entonces hacemos las 2 siguientes lineas.
    ...
    .then(data => {
        ...
        tableData += `</table>`
        document.querySelector("#prestamos").innerHTML += tableData;
    })