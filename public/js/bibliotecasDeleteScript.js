...
document.querySelector("#botonBorrarBiblioteca").addEventListener("click", function () {
    let objeto = {
    ...
    fetch("/bibliotecas/delete", fetchData) //le metemos la ruta en el servidor, y los datos que queremos que le meta. //cuando reciba la respuesta del app.get del index.js, entonces hacemos las 2 siguientes lineas.
